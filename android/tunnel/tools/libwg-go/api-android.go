...
// Serializes JNI entry points that touch the device / IPC. Concurrent awgGetConfig calls
// (e.g. status thread + Flutter getStats) can race with handshake on some devices.
