...
/// AmneziaWG connect path: Android needs notification permission; Linux uses the same [VpnPlatform] AWG bridge.
...
AmneziaWgRunner createAmneziaWgRunner() {
  ...
  return switch (defaultTargetPlatform) {
    ...
    _ => throw UnsupportedError('AmneziaWG runner is only for Android and Linux'),
  };
}
